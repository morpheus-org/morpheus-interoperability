...
typedef ccl_hvec_dense_v_hostmirror mirror_hvec;
...
int main() {
  ...
  { 
    ...
    { 
      mirror_csr *mirror = ccl_hmat_csr_create_mirror(refcsr);
    ...
    { 
      mirror_dia *mirror = ccl_hmat_dia_create_mirror(refdia);
    ...
    {
      dyn *A;
      ccl_hmat_dyn_create_from_hmat(refcsr, CSR_FORMAT, &A);
      mirror_dyn *mirror = ccl_hmat_dyn_create_mirror(A);
