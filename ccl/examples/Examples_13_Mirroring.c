...
int main() {
  ...
  { 
    ...
    { 
      mirror_coo *mirror = morpheus_ccl_create_mirror_mat_coo_r64_i32_r_h_serial(refcoo);
      coo *shallow_mirror = morpheus_ccl_create_mirror_container_mat_coo_r64_i32_r_h_serial(refcoo);

      morpheus_ccl_copy_mat_coo_to_mat_coo_hostmirror_r64_i32_r_h_serial(refcoo, mirror);
      morpheus_ccl_copy_mat_coo_to_mat_coo_hostmirror_r64_i32_r_h_serial(refcoo, shallow_mirror);

      morpheus_ccl_set_values_at_coo_r64_i32_r_h(refcoo, 5, -15);
      morpheus_ccl_print_mat_coo_r64_i32_r_h(mirror);
      morpheus_ccl_print_mat_coo_r64_i32_r_h(shallow_mirror);
      morpheus_ccl_set_values_at_coo_r64_i32_r_h(refcoo, 5, 60);
      
      morpheus_ccl_destroy_mat_coo_r64_i32_r_h(&mirror);
      morpheus_ccl_destroy_mat_coo_r64_i32_r_h(&shallow_mirror);
    }

    { 
      mirror_csr *mirror = morpheus_ccl_create_mirror_mat_csr_r64_i32_r_h_serial(refcsr);

      morpheus_ccl_copy_mat_csr_to_mat_csr_hostmirror_r64_i32_r_h_serial(refcsr, mirror);
      morpheus_ccl_set_values_at_csr_r64_i32_r_h(refcsr, 5, -15);
      morpheus_ccl_print_mat_csr_r64_i32_r_h(mirror);
      morpheus_ccl_set_values_at_csr_r64_i32_r_h(refcsr, 5, 60);
      morpheus_ccl_destroy_mat_csr_r64_i32_r_h(&mirror);
    }

    { 
      mirror_dia *mirror = morpheus_ccl_create_mirror_mat_dia_r64_i32_r_h_serial(refdia);

      morpheus_ccl_copy_mat_dia_to_mat_dia_hostmirror_r64_i32_r_h_serial(refdia, mirror);
      morpheus_ccl_set_values_at_dia_r64_i32_r_h(refdia, 3, 0, -15);
      morpheus_ccl_print_mat_dia_r64_i32_r_h(mirror);
      morpheus_ccl_set_values_at_dia_r64_i32_r_h(refdia, 3, 0, 60);
      morpheus_ccl_destroy_mat_dia_r64_i32_r_h(&mirror);
    }

    {
      dyn *A;
      morpheus_ccl_create_mat_dyn_from_mat_r64_i32_r_h(refcsr, CSR_FORMAT, &A);
      mirror_dyn *mirror = morpheus_ccl_create_mirror_mat_dyn_r64_i32_r_h_serial(A);

      morpheus_ccl_copy_mat_csr_to_mat_dyn_hostmirror_r64_i32_r_h_serial(refcsr, mirror);
      morpheus_ccl_set_values_at_csr_r64_i32_r_h(refcsr, 5, -15);
      morpheus_ccl_print_mat_dyn_r64_i32_r_h(mirror);
      morpheus_ccl_set_values_at_csr_r64_i32_r_h(refcsr, 5, 60);

      morpheus_ccl_destroy_mat_dyn_r64_i32_r_h(&A);
      morpheus_ccl_destroy_mat_dyn_r64_i32_r_h(&mirror);
    }
