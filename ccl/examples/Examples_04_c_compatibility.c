...
int main() {
  ccl_initialize_without_args();
  {
    ...
    ccl_hmat_dyn_create_from_hmat(A, COO_FORMAT, &Adyn);
    ...
    ccl_hmat_coo_create_from_hmat_dyn(Adyn, &Afromdyn);
    ccl_hmat_coo_print(Afromdyn);
    ccl_hmat_coo_set_values_at(A, 2, -22.5);
    ccl_hmat_dyn_print(Adyn);

    ccl_hmat_dyn_activate(Adyn, CSR_FORMAT);
    ccl_hmat_dyn_print(Adyn);
