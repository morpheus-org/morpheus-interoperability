...
void morpheus_ccl_destroy_vec_dense(ccl_vec_dense** v) { delete (*v); }

ccl_index_t morpheus_ccl_size_vec_dense(ccl_vec_dense* v) { return v->size(); }

ccl_value_t* morpheus_ccl_data_vec_dense(ccl_vec_dense* v) { return v->data(); }
