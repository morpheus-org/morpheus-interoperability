...
#ifndef MORPHEUS_CCL_PHOST_COOMATRIX_HPP
#define MORPHEUS_CCL_PHOST_COOMATRIX_HPP
...
void ccl_phmat_coo_destroy(ccl_phmat_coo** A);

// Base Routines
ccl_index_t ccl_phmat_coo_nrows(ccl_phmat_coo* A);
ccl_index_t ccl_phmat_coo_ncols(ccl_phmat_coo* A);
ccl_index_t ccl_phmat_coo_nnnz(ccl_phmat_coo* A);
...
ccl_phvec_dense_v* ccl_phmat_coo_values_coo(ccl_phmat_coo* A);
...
void ccl_phmat_coo_hostmirror_create_from_phmat_dyn(
    ccl_phmat_dyn* src, ccl_phmat_coo_hostmirror** dst);
...
ccl_phvec_dense_i_hostmirror* ccl_phmat_coo_hostmirror_column_indices(
    ccl_phmat_coo_hostmirror* A);
ccl_phvec_dense_v_hostmirror* ccl_phmat_coo_hostmirror_values_coo_hostmirror(
    ccl_phmat_coo_hostmirror* A);
...
// Other Routines
ccl_formats_e ccl_phmat_coo_hostmirror_format_enum(ccl_phmat_coo_hostmirror* A);
...
#endif  // MORPHEUS_CCL_PHOST_COOMATRIX_HPP
