...
ccl_hvec_dense_i_hostmirror* ccl_hmat_coo_hostmirror_column_indices(
    ccl_hmat_coo_hostmirror* A);
ccl_hvec_dense_v_hostmirror* ccl_hmat_coo_hostmirror_values_coo_hostmirror(
    ccl_hmat_coo_hostmirror* A);
...
void ccl_hmat_coo_hostmirror_sort_by_row_and_column(ccl_hmat_coo_hostmirror* A);
ccl_bool_t ccl_hmat_coo_hostmirror_is_sorted_by_row(ccl_hmat_coo_hostmirror* A);
