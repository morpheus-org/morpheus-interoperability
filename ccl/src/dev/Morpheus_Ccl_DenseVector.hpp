...
#ifndef MORPHEUS_CCL_DEV_DENSEVECTOR_HPP
#define MORPHEUS_CCL_DEV_DENSEVECTOR_HPP
...
void ccl_dvec_dense_v_destroy(ccl_dvec_dense_v** v);

ccl_index_t ccl_dvec_dense_v_size(ccl_dvec_dense_v* v);

ccl_value_t* ccl_dvec_dense_v_data(ccl_dvec_dense_v* v);

ccl_value_t ccl_dvec_dense_v_values_at(ccl_dvec_dense_v* v, ccl_index_t i);

void ccl_dvec_dense_v_set_values_at(ccl_dvec_dense_v* v, ccl_index_t i,
                                    ccl_value_t val);
...
void ccl_dvec_dense_i_destroy(ccl_dvec_dense_i** v);

ccl_index_t ccl_dvec_dense_i_size(ccl_dvec_dense_i* v);

ccl_index_t* ccl_dvec_dense_i_data(ccl_dvec_dense_i* v);
...
#endif  // MORPHEUS_CCL_DEV_DENSEVECTOR_HPP
