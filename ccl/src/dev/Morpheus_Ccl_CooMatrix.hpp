...
#ifndef MORPHEUS_CCL_DEV_COOMATRIX_HPP
#define MORPHEUS_CCL_DEV_COOMATRIX_HPP
...
void ccl_dmat_coo_destroy(ccl_dmat_coo** A);

// Base Routines
ccl_index_t ccl_dmat_coo_nrows(ccl_dmat_coo* A);
ccl_index_t ccl_dmat_coo_ncols(ccl_dmat_coo* A);
ccl_index_t ccl_dmat_coo_nnnz(ccl_dmat_coo* A);
...
ccl_dvec_dense_v* ccl_dmat_coo_values_coo(ccl_dmat_coo* A);

// Other Routines
ccl_formats_e ccl_dmat_coo_format_enum(ccl_dmat_coo* A);
int ccl_dmat_coo_format_index(ccl_dmat_coo* A);
...
void ccl_dmat_coo_hostmirror_create_from_dmat_dyn(
    ccl_dmat_dyn* src, ccl_dmat_coo_hostmirror** dst);
...
ccl_dvec_dense_i_hostmirror* ccl_dmat_coo_hostmirror_column_indices(
    ccl_dmat_coo_hostmirror* A);
ccl_dvec_dense_v_hostmirror* ccl_dmat_coo_hostmirror_values_coo_hostmirror(
    ccl_dmat_coo_hostmirror* A);
...
void ccl_dmat_coo_hostmirror_sort_by_row_and_column(ccl_dmat_coo_hostmirror* A);
ccl_bool_t ccl_dmat_coo_hostmirror_is_sorted_by_row(ccl_dmat_coo_hostmirror* A);
